...
namespace AdminApi.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public ActionResult GetLoginInfo(string username, string password)
        {
            try
            {
                var user= (from u in _context.Users join r in _context.UserRole on u.UserRoleId 
                equals r.UserRoleId where u.IsActive.Equals(true) && u.UserName.Equals(username) && u.Password.Equals(password)
        ...
        public ActionResult GetUserList()
        {
            try
            {
                var list=(from u in _context.Users join r in _context.UserRole on 
